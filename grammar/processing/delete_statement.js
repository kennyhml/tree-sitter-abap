module.exports = {
  ...
  delete_itab_key_spec: $ =>
    seq(
      ...
      choice($.itab_work_area_spec, $.itab_table_key_spec),
    ),
  ...
  delete_itab_index_spec: $ =>
    seq(
      field("subject", $.general_expression),
      optional(choice(field("key", $.using_loop_key_spec), $.itab_index_spec)),
    ),
   ...
   */
  delete_itab_lines_spec: $ =>
    seq(field("subject", $.general_expression), field("lines", $.itab_lines)),
