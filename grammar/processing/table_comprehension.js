module.exports = {
   ...
   *
   * WARN: Do not allow general expressions here, as that would include a parenthesized
   * expression which causes ambiguity.
   *
  ...
  table_comprehension: $ =>
    seq(
      ...
      repeat1(seq(repeat($.named_argument), $.line_spec)),
    ),
