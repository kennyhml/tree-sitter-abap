module.exports = {
  ...
  substring_access: $ =>
    prec.right(
      ...
      seq(
        ...
        choice(
          seq($.__substring_offset, optional($.__substring_length)),
          $.__substring_length,
        ),
      ),
    ),
  ...
  __substring_offset: $ =>
    seq(
      token.immediate("+"),
      field("offset", choice($._immediate_number, $._immediate_identifier)),
    ),

  __substring_length: $ =>
    seq(
      token.immediate("("),
      field("length", choice($._immediate_number, $._immediate_identifier)),
      token.immediate(")"),
    ),
};
