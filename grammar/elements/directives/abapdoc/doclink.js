module.exports = {
   ...
   */
  doclink: $ => seq(token.immediate("{"), "@link", $.linked_object_path, "}"),
    ...
    prec.right(
      choice(
        ...
        seq(
          choice(
            seq(
              field("locator", choice($.linked_object_path, $.linked_node)),
              ".",
            ),
  ...
  linked_node: $ =>
    seq(
      optional(seq(field("kind", $.linked_object_kind), token.immediate(":"))),
      field("name", $.identifier),
    ),

  scope_directive: _ => prec.left(repeat1(".")),

  linked_object_kind: _ =>
    choice(
      ...gen.caseInsensitive(
